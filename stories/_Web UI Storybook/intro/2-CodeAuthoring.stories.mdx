...
- The `WebUI repo` that bundles all the static UI assets for this Storybook contains a [README](TBC/_git/WebUI?path=%2FREADME.md&_a=preview) which explains:
    - JavaScript and CSS architecture.
    - Progressive enhancement, and **"no JavaScript"** behaviour.
    - CSS namespacing with `BEM` conventions and `kb-` prefixes.
