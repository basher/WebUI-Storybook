...
# Quick view item
- This is a composite component made up of [Asymmetric grid](/story/ui-components-layouts-grid--grid-asymmetric), [Responsive video](/story/ui-components-responsive-media--responsive-video), [Product toolbar](/story/ui-components-toolbar-product-toolbar--toolbar-product), [Product summary](/story/ui-components-product-product-summary--product-summary) and [Product specs (subset)](/story/ui-components-product-product-specs--product-specs) components.
